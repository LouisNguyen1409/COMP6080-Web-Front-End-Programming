...
console.log(`List of negatives = [${numbers.filter(x => x < 0).sort((a, b) => a - b)}]`);
console.log(`Average of positive numbers 6 divisible = = ${numbers.filter(x => x > 0 && x % 6 === 0).reduce((a, b) => a + b, 0) / numbers.filter(x => x > 0 && x % 6 === 0).length}`);
console.log(`List of large numbers in reverse = [${numbers.filter(x => x > 600).reverse()}]`);
